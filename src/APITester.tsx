...
export function APITester() {
    ...
    const testEndpoint = async (e: FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            // biome-ignore lint/style/noNonNullAssertion: <The response input is guaranteed to be non-null>
    ...
    return (
        <div className="flex flex-col gap-6">
            ...
            <Textarea ref={responseInputRef} id="response" readOnly placeholder="Response will appear here..." className="min-h-[140px] resize-y font-mono" />
        </div>
    );
}
